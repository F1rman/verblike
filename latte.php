<script type='text/javascript' src="<?php echo get_stylesheet_directory_uri(); ?>/assets/plugins.min.js"></script>

<script type='text/javascript'>

/* <![CDATA[ */
var latte_script_var = {"latte_preloader_display":"","latte_animations_display":"","latte_is_homepage":"0","latte_intro_background":"<?php echo str_replace('"', '', json_encode(get_stylesheet_directory_uri())); ?>\/assets\/images\/intro.jpg","latte_about_background":"","latte_social_background":"<?php echo str_replace('"', '', json_encode(get_stylesheet_directory_uri())); ?>\/assets\/images\/social.jpg","latte_services_background":"","latte_separator_background":"<?php echo str_replace('"', '', json_encode(get_stylesheet_directory_uri())); ?>\/assets\/images\/separator.jpg","latte_skills_background":"","latte_portfolio_background":"","latte_subscribe_background":"<?php echo str_replace('"', '', json_encode(get_stylesheet_directory_uri())); ?>\/assets\/images\/subscribe.jpg","latte_pricing_background":"","latte_testimonials_background":"<?php echo str_replace('"', '', json_encode(get_stylesheet_directory_uri())); ?>\/assets\/images\/testimonials.jpg","latte_blogposts_background":"","latte_contact_background":"<?php echo str_replace('"', '', json_encode(get_stylesheet_directory_uri())); ?>\/assets\/images\/contact.jpg","latte_menu_display":"","latte_intro_display":"","latte_about_display":"","latte_social_display":"","latte_services_display":"","latte_separator_display":"","latte_skills_display":"","latte_portfolio_display":"","latte_subscribe_display":"","latte_pricing_display":"","latte_testimonials_display":"","latte_blogposts_display":"","latte_contact_display":""};
/* ]]> */
